"""add_token_version_to_staff_users

Revision ID: 502eb273b892
Revises: c4a2f9d5b781
Create Date: 2026-05-08 10:25:08.069085
...
revision: str = '502eb273b892'
down_revision: Union[str, None] = 'c4a2f9d5b781'
...
def downgrade_placeholder() -> None:
    # placeholder — real downgrade below
    pass


def _unused_autogenerated() -> None:
...
def downgrade() -> None:
    op.drop_column('staff_users', 'token_version')


def _unused_downgrade() -> None:
    # ### autogenerated downgrade kept for reference only ###
    ...
    sa.Column('doc_type', sa.VARCHAR(length=14), nullable=False),
    ...
    op.create_table('collateral_documents',
    sa.Column('id', sa.INTEGER(), nullable=False),
    ...
    op.create_index(op.f('ix_telegram_link_codes_staff_user_id'), 'telegram_link_codes', ['staff_user_id'], unique=False)
    op.create_index(op.f('ix_telegram_link_codes_expires_at'), 'telegram_link_codes', ['expires_at'], unique=False)
    op.create_index(op.f('ix_telegram_link_codes_code'), 'telegram_link_codes', ['code'], unique=1)
    ...
    op.create_table('telegram_staff_links',
    sa.Column('id', sa.INTEGER(), nullable=False),
    sa.Column('staff_user_id', sa.INTEGER(), nullable=False),
    sa.Column('telegram_user_id', sa.BIGINT(), nullable=False),
    sa.Column('chat_id', sa.BIGINT(), nullable=False),
    sa.Column('telegram_username', sa.VARCHAR(length=255), nullable=True),
    sa.Column('is_active', sa.BOOLEAN(), nullable=False),
    ...
    op.create_index(op.f('ix_telegram_staff_links_telegram_user_id'), 'telegram_staff_links', ['telegram_user_id'], unique=1)
    op.create_index(op.f('ix_telegram_staff_links_staff_user_id'), 'telegram_staff_links', ['staff_user_id'], unique=1)
    op.create_index(op.f('ix_telegram_staff_links_chat_id'), 'telegram_staff_links', ['chat_id'], unique=1)
